...
CREATE TABLE "quiz_results" (
    "id" TEXT NOT NULL,
    "owner" TEXT NOT NULL,
    "realistic_score" TEXT NOT NULL,
    "investigative_score" TEXT NOT NULL,
    "artistic_score" TEXT NOT NULL,
    "social_score" TEXT NOT NULL,
    "enterprising_score" TEXT NOT NULL,
    "conventional_score" TEXT NOT NULL,
